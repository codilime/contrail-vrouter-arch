...
{
	// TODO: Implement nl_build_genlh for windows platform - mariusz
	/*
...
{
	// TODO: Implement nl_socket for windows platform - mariusz
	return -1;
		/*
    if (cl->cl_sock >= 0)
        return -EEXIST;
...
{
	// TODO: Implement nl_connect for windows platform - mariusz
	/*
...
{
	// TODO: Implement nl_parse_replay for windows platform - mariusz
	return 0;
	/*
    struct nlmsghdr *nlh = (struct nlmsghdr *)(cl->cl_buf +
            cl->cl_buf_offset);
...
{
	// TODO: Implement vrouter_get_family_id for windows platform - mariusz
	return -1;
	/*
    int ret;
